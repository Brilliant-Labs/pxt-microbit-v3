...
namespace servos {
    ...
    export class PinMicroServo extends microbit_servo {
    ...
    export const P00 = new servos.PinMicroServo(pins.P0);
    //% block="servo P1" fixedInstance whenUsed
    export const P01 = new servos.PinMicroServo(pins.P1);
    //% block="servo P2" fixedInstance whenUsed
    export const P02 = new servos.PinMicroServo(pins.P2);
}
